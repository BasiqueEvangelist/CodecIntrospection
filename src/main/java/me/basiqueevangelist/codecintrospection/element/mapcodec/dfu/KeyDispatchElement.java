...
import me.basiqueevangelist.codecintrospection.mixin.mapcodec.dfu.KeyDispatchCodecAccessor;
...
public class KeyDispatchElement implements MapCodecIntrospectionElement {
    ...
    @ApiStatus.Internal
    public static @Nullable KeyDispatchElement fromMapCodec(MapCodec<?> codec) {
