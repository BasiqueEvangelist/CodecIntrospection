...
import me.basiqueevangelist.codecintrospection.mixin.dfu.mapcodec.MappedMapDecoderAccessor;
import me.basiqueevangelist.codecintrospection.mixin.dfu.mapcodec.UnitMapDecoderAccessor;
import me.basiqueevangelist.codecintrospection.mixin.dfu.record.*;
...
public record RecordElement(MapCodec<?> original, List<IntrospectionElement> fields) implements MapCodecIntrospectionElement {
    static @Nullable RecordElement fromMapCodec(MapCodec<?> codec) {
